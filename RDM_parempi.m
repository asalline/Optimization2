...
original_rho = randomdensitymatrix1(qubits, ranknum, real);

function original_rho = randomdensitymatrix1(qubits, ranknum, real)
...
%This part makes the obtained density matrix global.
global original_rho;
original_rho = rho;
clear rho
